Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "http://EXAMPLE/FamilySearchAPI"
  ...
  #
  s.source       = { :git => "http://EXAMPLE/FamilySearchAPI.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/FamilySearchAPI/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/FamilySearchAPI', :revision => '1.0.0' }
